...
═══ FORMAT JSON STRICT ═══
{
  ...
  "prompt_hero_poster": "[Generate in English: BOLD ADVERTISING POSTER for THIS SPECIFIC product (describe its exact name, type, color, packaging). Square 1:1 graphic-design meets product photography. The product shown LARGE, dominant, perfectly sharp (min 40% of frame), exact same packaging/color/shape. Premium dark gradient background (deep midnight blue to black, OR deep forest green to charcoal, or deep burgundy — choose what contrasts best with product colors). Dramatic cinematic lighting with product glow. MANDATORY: An authentic Black African person (dark skin, natural features, natural African hair) must be visible — holding, using, or standing with the product. Natural expression, simple everyday clothing. MANDATORY: 1 bold French headline in large modern sans-serif font at top or bottom — CRITICAL: French text MUST be 100% perfectly spelled with all accents, ZERO errors. NO price, NO phone, NO fake button, NO URL. Mood: aspirational, premium brand launch poster adapted for African market. Quality like high-end smartphone photo.]",
  "prompt_avant_apres": "[Generate in English: Photorealistic split-screen before/after transformation image for the African market. Quality like a high-end smartphone photo — MUST look like a REAL photograph, NOT AI-generated. LEFT (AVANT): the SPECIFIC problem this product solves — the problem must be PHYSICALLY and VISUALLY visible (skin damage, fatigue, discomfort, disorder, etc.), NOT just suggested or emotional. Show a CONCRETE visual problem. RIGHT (APRÈS): CREDIBLE realistic improvement — the change must be PHYSICAL and VISUAL, directly related to the product benefit. NOT just 'sad face vs smile' — show a REAL visible difference (clearer skin, shinier hair, relieved posture, etc.). MANDATORY: Authentic Black African person (dark skin, natural African features and realistic traits — NOT caricatural, natural African hair). Simple everyday African clothing, SUBTLE natural facial expressions — NOT theatrical or exaggerated. Setting: realistic African home environment (bathroom, bedroom, living room) with coherent local decor. The SAME person on both sides. Product visible at its REAL SIZE on the AFTER side — natural placement in hand or on surface, NOT oversized. Small 'Avant'/'Après' labels in PERFECT French (zero spelling errors). Square 1:1, tight crop. Soft natural lighting, clean soft style, natural colors — NO aggressive filters, NO over-saturation, NO flashy effects. Match the EXACT body zone of the product.]",
  "angles": [
    {
