...
const SuperAdminSettings = () => {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-2xl mx-auto space-y-6">
      ...
      {error && (
        <div className="flex items-center gap-3 p-4 bg-amber-50 border border-amber-200/80 rounded-xl text-sm text-amber-800">
          <span className="flex-shrink-0 w-5 h-5 rounded-full bg-amber-500 flex items-center justify-center text-white text-xs">!</span>
          {error}
        </div>
      )}
        ...
        <form onSubmit={handlePasswordChange} className="p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-600/40 focus:border-emerald-500 transition"
            />
          </div>
          <div>
