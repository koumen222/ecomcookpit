            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="flex justify-end mt-1.5">
                  <button type="button" onClick={() => navigate('/ecom/forgot-password')} className="text-xs text-primary-600 hover:text-primary-700 font-medium transition">
                    Mot de passe oublié ?
                  </button>
                </div>
              </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 max-w-md w-full mx-auto shadow-2xl">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={registeringDevice}
                className="flex-1 px-4 py-2.5 bg-primary-600 hover:bg-primary-700 rounded-xl text-sm font-semibold text-white transition disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {registeringDevice ? (
                  <>
