    ...
    return (
        <div className="min-h-screen bg-gray-950 p-4 md:p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                {[
                    { label: 'Total', value: stats.total, gradient: 'from-emerald-600 to-emerald-700', icon: MessageSquare },
                    ...
                    { label: 'Rejetées', value: stats.rejected, gradient: 'from-red-500 to-amber-500', icon: XCircle },
                ].map(s => (
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
                <div className="relative flex-1 max-w-md">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 bg-gray-900/60 border border-gray-800 rounded-xl text-sm text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-emerald-600 focus:border-emerald-600 transition"
                    />
                </div>
            ...
            {!loading && filtered.length > 0 && (
                <div className="space-y-3">
                    {filtered.map(p => {
                        ...
                        return (
                            <div key={p._id} className={`bg-gray-900/50 border rounded-2xl overflow-hidden transition-all duration-300 ${isExpanded ? 'border-emerald-700/40 shadow-lg shadow-emerald-900/20' : 'border-gray-800/60 hover:border-gray-700/60'
                                }`}>
                                {/* Header row */}
                                <button
                                            ...
                                            <div className="bg-gray-800/40 rounded-xl p-4 space-y-2">
                                                ...
                                                <div className="space-y-1.5">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-emerald-500 font-medium">{p.workspaceName}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="bg-gray-800/30 rounded-xl p-4 border border-gray-700/40">
                                            ...
                                            <div className="flex flex-col sm:flex-row gap-3">
                                                <input
                                                    ...
                                                    className="flex-1 px-3 py-2 bg-gray-900/60 border border-gray-700 rounded-lg text-sm text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-emerald-600 transition"
                                                />
                                                <div className="flex gap-2">
                                                    ...
                                                    {p.status !== 'rejected' && (
                                                        <button
                                                            ...
                                                            disabled={actionLoading === p._id}
                                                            className="flex items-center gap-1.5 px-4 py-2 bg-gradient-to-r from-red-600 to-amber-500 text-white text-sm font-medium rounded-lg hover:from-red-500 hover:to-amber-400 transition-all shadow-lg shadow-red-900/30 disabled:opacity-50"
                                                        >
