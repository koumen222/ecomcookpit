    ...
    return (
      <div className="relative">
        <button
          ...
          disabled={loading}
          className="flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-sm hover:border-emerald-500 transition disabled:opacity-50"
        >
                    ...
                    {regionCurrencies.map((currency) => (
                      <button
                        ...
                        className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-50 flex items-center gap-3 ${
                          currentCurrency === currency.code ? 'bg-emerald-50 text-emerald-700' : 'text-gray-700'
                        }`}
                      >
                ...
                {regionCurrencies.map((currency) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className={`font-medium text-sm ${currentCurrency === currency.code ? 'text-emerald-900' : 'text-gray-900'}`}>
                        {currency.name}
                      </div>
