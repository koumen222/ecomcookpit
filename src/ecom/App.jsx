...
const SuperAdminFeedback = lazy(() => import('./pages/SuperAdminFeedback.jsx'));
...
const PLATFORM_TITLE_RULES = [
  ...
  { path: '/ecom/super-admin/feedbacks', title: 'Feedbacks utilisateurs' },
        ...
        <div className="min-h-screen">
          ...
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route path="/ecom/transactions/:id/edit" element={<LayoutRoute requiredRole={['ecom_admin', 'ecom_compta']}><TransactionForm /></LayoutRoute>} />
              ...
              <Route path="/ecom/super-admin/feedbacks" element={<LayoutRoute requiredRole="super_admin"><SuperAdminFeedback /></LayoutRoute>} />
